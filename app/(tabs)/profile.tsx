import { View, Text, TouchableOpacity, ScrollView, FlatList, Modal, TouchableWithoutFeedback, KeyboardAvoidingView, Platform, Keyboard, TextInput } from 'react-native'
